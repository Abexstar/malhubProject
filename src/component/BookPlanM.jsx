      ...
      <div>
        ...
        <div>
          ...
          <p className="mx-32 font-sans font-normal text-[20px] leading-[19px] grid items-center">
            MALhub monthly subscription packages
          </p>
        
        </div>
    
    <div className=" px-32 py-20 gap-10 grid grid-cols-3  ">
      {Packages.map((items, id) => {
        ...
        return (
          <div
            key={id}
            className=" px-5 py-4 flex flex-col items-center justify-between h-[100dvh] bg-blue-50 border border-blue-100 rounded-3xl shadow-2xl"
          >
            ...
            >
              <Link to='/payment'>{cta}</Link></button>
          </div>
  );})}
